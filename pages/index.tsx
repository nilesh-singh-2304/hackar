   ...
   <nav
          ...
          <div className="hidden w-full lg:flex justify-between max-lg:bg-white py-5 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
            ...
            >
              <li>
                <a
                  href="javascript:;"
                  className="text-gray-300 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-gray-900"
                  >Home</a>
              </li>
              <li>
                <a
              ...
              <li className="relative">
                <button
                  ...
                  className="dropdown-toggle flex items-center justify-between text-gray-300 text-sm lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 lg:mr-6 lg:mb-0 mr-auto lg:text-left  lg:m-0 hover:text-gray-900"
                >
                  Products
                  <svg
                ...
                >
                  <div className="flex flex-col sm:flex-row lg:justify-between">
                    <ul className="text-sm text-gray-700 lg:w-1/2">
                      <h6 className="font-medium text-sm text-gray-300 mb-2">
                        Features
                      </h6>
                      <li className="">
                        <a
    ...
    <section className="py-24 relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12">
                <h2 className="font-manrope text-5xl text-center font-bold text-white mb-4">Top Selling Points</h2>
                <p className="text-gray-300 text-xl text-center leading-6">7 Days free trial. No credit card required.</p>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/pagedone.svg">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">1 Month Plan</h3>
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">$200</span>
                        ...
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">
                                ...
                                <span>AI Summarizer For a day</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* <!-- Icon --> */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                                <span>Notes Making Section</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* <!-- Icon --> */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                                <span>AI-Assistant for doubts-solving</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* <!-- Icon --> */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                                ...
                                <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/pagedone.svg">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">6 Month Plan</h3>
                        <div className="flex items-center justify-center">
                        ...
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">
                                {/* <!-- Icon --> */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                                <span>AI Summarizer full time</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* <!-- Icon --> */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  ...
                  <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    ...
                    <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Full Year Plan</h3>
                    <div className="flex items-center justify-center">
                        <span className="font-manrope text-4xl font-medium text-gray-900">$100</span>
                        <span className="text-xl text-gray-500 ml-3">|&nbsp; Month</span>
                    </div>
                </div>
                    {/* <!--List--> */}
