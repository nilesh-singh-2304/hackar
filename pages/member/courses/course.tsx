...
const Index =({course}) => {
  ...
  return (
    <div>
      ...
      <div className="p-4 flex sm:ml-64">
      
   <div className="p-4 w-2/3 border-2 overflow-y-scroll h-150 border-gray-300  shadow-xl rounded-lg  mt-14">
      <div className='w-full flex justify-center items-center font-bold text-3xl'>{course.name}</div>
      {/* <input type="checkbox" value="dark" className="toggle theme-controller" /> */}

      <div className='w-full mt-10 flex-col flex justify-center items-center'>
   ...
   <div className='w-1/3'>
   <div className=" w-full ml-2 h-96 border-2 overflow-y-scroll border-gray-300 shadow-xl rounded-lg mt-14">
      <div className='w-full flex justify-center items-center font-bold text-3xl'>Notes</div>
      {/* <input type="checkbox" value="dark" className="toggle theme-controller" /> */}

      <div className='w-full mt-3 flex-col flex justify-center items-center'>
        
<form>
   <div className="w-96 h-80 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea id="editor" rows={8} className="block w-full h-64 px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
       </div>
   </div>
   ...
   <div className="p-4 w-full ml-2 h-64 border-2 overflow-y-scroll border-gray-300 shadow-xl rounded-lg mt-1 ">
      <div className='w-full flex justify-center items-center font-bold text-3xl'>Reference Links</div>
      {/* <input type="checkbox" value="dark" className="toggle theme-controller" /> */}
...
export async function getServerSideProps(context) {
    if(!mongoose.connections[0].readyState){
      ...
      let courses = await course.findById(context.query.id)

  return {
    props: {course : JSON.parse(JSON.stringify(courses))},
  }; 
}
