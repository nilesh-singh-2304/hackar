...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center'>
      <div className="scale-75 font-[sans-serif]">
      <div className="grid lg:grid-cols-2 md:grid-cols-2 items-center gap-4">
      <div className="embla" ref={emblaRef}>
      <div className="embla__container">
        <div className="embla__slide">
        <div className="max-md:order-1 h-screen min-h-full">
          <img src="https://readymadeui.com/image-3.webp" className="w-full h-full object-cover rounded-md" alt="login-image" />
        </div>
        </div>
        <div className="embla__slide">
        <div className="max-md:order-1 h-screen min-h-full">
        ...
        <form className="max-w-xl scale-110 w-full p-6 mx-auto">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              <input value={name} onChange={handleChange} name="name" type="text" required className="w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
          ...
          <div className="mt-8">
            ...
            <div className="relative flex items-center">
              <input value={password} onChange={handleChange} name="password" type="password" required className="w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
