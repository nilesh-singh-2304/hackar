...
const Summary = () => {
    ...
    const handleSubmit = async() =>{
        const res = await axios.post(`${process.env.NEXT_PUBLIC_HOST}/api/summary`, {
            url : url
          }
        )
  ...
  return (
   ...
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      ...
      <div className="text-center max-w-3xl max-md:max-w-md mx-auto">
        ...
        <h2 className="text-gray-800 md:text-5xl text-3xl font-extrabold md:!leading-[55px]">Call AI to Elevate Your Experience</h2>
        <div className="mt-8">
          <p className="text-base text-gray-500 leading-relaxed">Need a quick summary? Our AI-powered text summarizer instantly condenses lengthy articles, reports, or documents into concise and clear summaries. Save time and get the key points at a glance with just one click!</p>
        </div>
...
<div className="chat-bubble chat-bubble-success">{resp}</div>
</div>
</div> }
      </div>
    </div>
